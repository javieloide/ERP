...
<body>
<h1>Listado pedidos entre fechas</h1>
<!--Sería conveniente utilizar AJAX en este script para recargar-->
<form name="formularioFiltro" method="POST" action="../vista_admin/IndexAdmin.php?principal=pedido/listadoPedidosEntreFechas.php">
...
if(isset($_POST['buscar'])){
	...
	$tablaPedidos = $tp->getPedidosEntreFechas($_POST['fechaInicio'],$_POST['fechaFin']);
