...
<head>
 ...
 <link href="//netdna.bootstrapcdn.com/bootstrap/3.1.0/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
  ...
  <title>Alta de un Departamento</title>
</head>
<body>
  <h1>Formulario de alta de un departamento </h1>

<form name="formularioAlta" method="POST" action="../vista_admin/IndexAdmin.php?principal=departamento/altaDepartamento.php">
 ...
 // require_once 'pojos/DireccionesCliente.php';
  ...
  if (isset($_POST['alta'])) { //si se ha pulsado el botón de guardar
    ...
    $codigo=$tDepartamento->getNumeroDepartamentos()+1;
...
//Instancia a la clase Cliente
    $c = new Departamento(0, $idDepartamento, $nombre, $nombre,0);

//Instancia a la clase DireccionesCliente

    
    $insertado = $tDepartamento->addUnDepartamento($c);
    if (!$insertado) {
      echo "<div class="."'alert alert-danger'"." role="."'danger'".">
              No se ha insertado correctamente el departamento
            </div>";
    } else {
      //insertamos un modal de bootstrap 
      echo "<div class="."'alert alert-success'"." role="."'success'".">
           Se ha insertado correctamente el  departamento
          </div>";
   }
