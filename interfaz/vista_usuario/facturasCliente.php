...
<html>
<head>
	<title>Listado de pedidos facturados</title>
	<meta charset="utf-8">
...
$tablaPedidos = $tp->getPedidosFacturadosCliente($_SESSION['idCliente']);
...
$tlp = LineasPedidos::singletonLineasPedidos();
	...
	echo "<br><center><h1>Listado de pedidos facturados</h1></center><br>"; 
