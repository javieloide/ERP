...
<html>
<head>
	<title>Listado de pedidos servidos</title>
	<meta charset="utf-8">
...
$tablaPedidos = $tp->getPedidosServidosCliente($_SESSION['idCliente']);
...
$tlp = LineasPedidos::singletonLineasPedidos();
	...
	echo "<br><center><h1>Listado de pedidos servidos</h1></center><br>"; 
