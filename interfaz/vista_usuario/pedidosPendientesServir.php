...
<html>
<head>
	<title>Listado de pedidos pendientes de servir</title>
	<meta charset="utf-8">
...
$tablaPedidos = $tp->getPedidosPendientesCliente($_SESSION['idCliente']);
...
$tlp = LineasPedidos::singletonLineasPedidos();
	...
	echo "<br><center><h1>Listado de pedidos pendientes de servir</h1></center><br>"; 
		 	...
		 	echo "<div id='datos' class= 'card-header' id= 'heading$i'> 
			 			<h5 class= 'mb-0' > 
			 				<button class= 'btn btn-link' type= 'button' data-toggle= 'collapse' data-target= '#collapse$i' aria-expanded= 'false' 		aria-controls= 'collapse$i'"." >" .
                                "<img id='img' width='28%' src='interfaz/fotos/general/". "carrito-pedido.png". "'>".
								"<div id='caja'>
...
function pintarTablaLineasPedido($lp){
	...
	echo "<td>". "<img width='28%' src='interfaz/$rutaFoto' class='img-thumbnail'></td>";
	}
	echo " </tr>";
